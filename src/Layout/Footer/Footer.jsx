            ...
            <div className="container">
                <div className="footer__content">
                    <div className="footer__logo">
                        <Link to=""> <img className="footer__img" src={logo} alt="logo"/></Link>
                    ...
                    <ul>
                        ...
                        <li className="footer__li-info">Warhammer 40000</li>
                        <li className="footer__li-info">Настольные игры</li>
                        <li className="footer__li-info">Magic: the Gathering</li>
                        <li className="footer__li-info">Аксессуары для игр Краски</li>
                        <li className="footer__li-info">Аксессуары для моделизма</li>
                    </ul>

                    <ul>
                        <li className="footer__li">Правила клуба</li>
                        <li className="footer__li">Мероприятия</li>
                        <li className="footer__li">О нас</li>
                        <li className="footer__li">Контакты</li>
                        <li className="footer__li">Блог</li>
                    </ul>

                    <ul>
                        <li className="footer__li">Оплата и достака <br/>
                            Гарантия и возврат</li>
                    </ul>

                    <div className="footer__address">
                        <button className="footer__btn">Заказать звонок</button>
                        <p className="footer__address-tel">+7 (495) 911-10-11</p>
                        <p className="footer__address-street">msk@magicgoldfish.ru</p>
                        <div className="footer__address-icons">
                            <div>
                                <svg width="23" height="23" viewBox="0 0 23 23" fill="none"
                                    ...
                                    <defs>
                                        <clipPath id="clip0_2504_907">
                                            <rect width="22.8636" height="22.8636" fill="white"
                            ...
                            <div>
                                <svg width="24" height="23" viewBox="0 0 24 23" fill="none"
                                     xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M12.4361 9.45168V8.21051C12.4361 7.67267 12.5602 7.38307 13.429 7.38307H14.5047V5.31445H12.8498C10.7812 5.31445 9.95372 6.67974 9.95372 8.21051V9.45168H8.29883V11.5203H9.95372V17.7261H12.4361V11.5203H14.2564L14.5047 9.45168H12.4361Z"
                                        fill="#F9A43F"/>
                                    <rect x="1.59082" y="1.08887" width="20.8636" height="20.8636" rx="6"
                                          stroke="#F9A43F" />
                                </svg>
            ...
            <hr/>
                <div className="container">
                    <div className="footer__two">
                        ...
                        <div className="footer__two-icons">
                            ...
                            <div>
                                <svg width="29" height="18" viewBox="0 0 29 18" fill="none"
                                     xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M10.2358 1.87695H17.8495V15.6164H10.2358V1.87695Z" fill="#929292"/>
                                    <path
                        ...
                        <p className="footer__two-public">
