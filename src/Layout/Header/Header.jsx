        ...
        <header id="header" className="header">
            ...
            <div className="header__first">
                <div className="container">
                    <div className="header__first_content">
                        <div className="header__first-image">
                            <Link to="/"><img className="header__first-img" src={Logo}
                                                        alt="logo"/></Link>
                        </div>

                        <label className="header__first-label">
                        <span className="header__first-label-block">
                            <input className="input__search" placeholder="Найти игру" type="search"/>
                            <img className="header__first-label-block-img" src={Search} alt=""/>
                        </span>
                        </label>

                        <a className="header__first-telefon-a" href="">
                            <svg className="a__telefon" width="27" height="26" viewBox="0 0 27 26" fill="none"
                            ...
                            <p className="header__first-telefon">+7 (495) 911-10-11</p>
                        </a>

                        <div className="header__first-login_group">
                            <button className="header__first-login" onClick={() => dispatch(openPopup())}>
                ...
                <div className="container">
                    <div className="header_two_content">
                        ...
                        <ul className="header__two-list">
                            ...
                            <li><NavLink to="/aboutcenter">О центре</NavLink></li>
                            ...
                            <a href="">
                                <svg width="25" height="24" viewBox="0 0 25 24" fill="none"
                                    ...
                                    <path
                                        ...
                                        fill="#F9A43F"/>
                                    <rect x="2.83789" y="2.08887" width="20.8636" height="20.8636" rx="6"
                                          stroke="#F9A43F" />
                                </svg>
                            </a>
                            <a href="">
                                <svg width="24" height="23" viewBox="0 0 24 23" fill="none"
                                    ...
                                    <path
                                        ...
                                        fill="#F9A43F"/>
                                    <rect x="1.58984" y="1.08887" width="20.8636" height="20.8636" rx="6"
                                          stroke="#F9A43F" />
                                </svg>
                            </a>
                        </div>
